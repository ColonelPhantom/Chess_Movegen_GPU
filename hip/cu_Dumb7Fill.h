...
namespace Dumb7Fill {
	static constexpr __device__ uint64_t north(uint64_t index, uint64_t empty) {
	...
	static constexpr __device__ uint64_t south(uint64_t index, uint64_t empty) {
		empty ^= 18446744073709551615U;
		uint64_t flood = index;
		index = (index >> 8) & empty;
		flood |= index;
	...
	static constexpr __device__ uint64_t east(uint64_t index, uint64_t empty) {
		empty ^= 18446744073709551615U;
	...
	static constexpr __device__ uint64_t west(uint64_t index, uint64_t empty) {
		empty ^= 18446744073709551615U;
	...
	static constexpr __device__ uint64_t noEa(uint64_t index, uint64_t empty) {
		empty ^= 18446744073709551615U;
		empty &= 0xfefefefefefefefe;
		uint64_t flood = index;
		index = (index << 9) & empty;
	...
	static constexpr __device__ uint64_t soEa(uint64_t index, uint64_t empty) {
		empty ^= 18446744073709551615U;
		empty &= 0xfefefefefefefefe;
		uint64_t flood = index;
		index = (index >> 7) & empty;
	...
	static constexpr __device__ uint64_t noWe(uint64_t index, uint64_t empty) {
		empty ^= 18446744073709551615U;
		empty &= 0x7f7f7f7f7f7f7f7f;
		uint64_t flood = index;
		index = (index << 7) & empty;
	...
	static constexpr __device__ uint64_t soWe(uint64_t index, uint64_t empty) {
		empty ^= 18446744073709551615U;
		empty &= 0x7f7f7f7f7f7f7f7f;
		uint64_t flood = index;
		index = (index >> 9) & empty;
