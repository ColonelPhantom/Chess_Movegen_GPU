...
namespace SwitchLookup {
	__device__ uint64_t GetSliderHCond(uint32_t SliderSquare, uint64_t occupy) {
		uint64_t result{};
		switch (SliderSquare) {
		case 0:
			result = 2ull;
	...
	__device__ uint64_t GetSliderVCond(uint32_t SliderSquare, uint64_t occupy) {
		uint64_t result{};
		switch (SliderSquare) {
		case 0:
			result = 256ull;
	...
	__device__ uint64_t GetSliderD2Cond(uint32_t SliderSquare, uint64_t occupy) {
		uint64_t result{};
		switch (SliderSquare) {
		case 0:
			result = 0ull;
	...
	__device__ uint64_t GetSliderD1Cond(uint32_t SliderSquare, uint64_t occupy) {
		uint64_t result{};
		switch (SliderSquare) {
		case 0:
			result = 512ull;
	...
	__device__ uint64_t Rook(uint32_t square, uint64_t occupy) {
		return GetSliderHCond(square, occupy) | GetSliderVCond(square, occupy);
	}

	__device__ uint64_t Rook_Xray(uint32_t square, uint64_t occupy) {
		uint64_t attacks = Rook(square, occupy);
		return attacks ^ Rook(square, occupy ^ (attacks & occupy));
	}

	__device__ uint64_t Bishop(uint32_t square, uint64_t occupy) {
		return GetSliderD1Cond(square, occupy) | GetSliderD2Cond(square, occupy);
	}

	__device__ uint64_t Bishop_Xray(uint32_t square, uint64_t occupy) {
